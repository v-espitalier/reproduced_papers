...
def save_embeddings_to_json(embeddings: np.ndarray, labels: List[int], sentences: List[str], 
...
def main():
    ...
    save_embeddings_to_json(train_embeddings, train_labels, train_sentences, 
    ...
    save_embeddings_to_json(eval_embeddings, eval_labels, eval_sentences,
    ...
    save_embeddings_to_json(test_embeddings, test_labels, test_sentences,
                           args.output_dir, "test")
    
    print(f"\nAll embeddings saved to {args.output_dir}")
    print("\nTo load the embeddings back as datasets, use:")
    print(f"  from generate_embeddings import create_dataset_from_embeddings")
    print(f"  train_dataset = create_dataset_from_embeddings('{args.output_dir}', 'train')")
