...
def run_experiment(
    ...
    print(f"Running experiment {run_id} with random state {random_state} on BAS")
    ...
    print(
        f"BAS - Final train: {training_results['final_train_acc']:.4f}, test: {training_results['final_test_acc']:.4f}"
    )
...
def save_results(
    ...
    ax_loss.set_title("BAS - Training Loss")
    ...
    ax_train.set_title("BAS - Training Accuracy")
    ...
    ax_test.set_title("BAS - Test Accuracy")
    ...
    plt.tight_layout()
    plots_file = os.path.join(output_dir, "BAS_training_plots.png")
...
def main():
    ...
    output_dir = f"../results/BAS/{day}/{time_str}"
